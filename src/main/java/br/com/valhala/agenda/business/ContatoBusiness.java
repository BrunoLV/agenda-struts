package br.com.valhala.agenda.business;
...
import br.com.valhala.agenda.exception.BusinessException;
...
import br.com.valhala.agenda.persistencia.dao.impl.ContatoDaoImpl;
import br.com.valhala.agenda.persistencia.dao.impl.TelefoneDaoImpl;
...
public class ContatoBusiness {
    ...
    public List<Contato> listarTodosContatos() throws BusinessException {
        ...
        try {
            ...
            LOGGER.error(String.format("Ocorreu um erro ao buscar os registros na base do sistema. Erro: %s",
                    e.getMessage()), e);
    ...
    /**
     * Método utilizado para buscar um contato sem seus relacionamentos no banco de
     * dados.
     *
     * @param id
     * @return
    ...
    public Contato buscarContatoSemRelacionamentos(Integer id) throws BusinessException {
        ...
        try {
            ...
            LOGGER.error(
                    String.format("Ocorreu um erro ao buscar o registro na base do sistema. Erro: %s", e.getMessage()),
                    e);
    ...
    public Contato buscarContatoComRelacionamentos(Integer id) throws BusinessException {
        LOGGER.info(
                "Iniciado o proceso de busca de contato utilizando id trazendo dados do contato e relacionamentos.");
        Contato contato;
        try {
    ...
    public void removerContato(Integer id) throws BusinessException {
        ...
        try {
            ...
            this.session.rollback();
            LOGGER.error(
                    String.format("Ocorreu um erro ao remover o registro da base do sistema. Erro: %s", e.getMessage()),
                    e);
