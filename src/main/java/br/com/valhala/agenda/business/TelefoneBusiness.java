...
/**
 * Classe de negócio para tratar de ações relacionadas a telefone dentro do
 * sistema.
 */
public class TelefoneBusiness {
    ...
    /**
     * Metodo utilizado para buscar um telefone na base do sistema utilizando seu
     * id.
     *
     * @param id
     * @return
    ...
    /**
     * Metodo utilizado para buscar todos os telefones registrados na base do
     * sistema de um determinado contato.
     *
     * @param idContato
     * @return
     * @throws BusinessException
