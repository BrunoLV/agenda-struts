...
public class ManipulacaoContatosAction extends Action {
     ...
     */
    private String removerRegistro(ActionMapping mapping,
                                   ContatoActionForm form,
                                   HttpServletRequest request,
                                   HttpServletResponse response,
                                   ContatoBusiness business) throws Exception {
    ...
    private String detalharContato(ActionMapping mapping,
                                   ContatoActionForm form,
                                   HttpServletRequest request,
                                   HttpServletResponse response,
                                   ContatoBusiness business,
                                   TelefoneBusiness telefoneBusiness) throws Exception {
        Contato contato = business.buscarContatoSemRelacionamentos(form.getId());
