	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form id="listagemTelefones" method="post">
				...
				<button class="btn btn-primary" onclick="javascript:direcionarInclusaoTelefone();" data-toggle="tooltip" title="Novo">
					<span class="glyphicon glyphicon-plus"></span>
				</button>
				<input type="hidden" id="acao" name="acao"> <input type="hidden" id="id" name="id"> <br /> <br />
					...
					<table class="table table-striped table-bordered table-hover table-condensed">
						...
						<c:forEach items="${telefones}" var="telefone">
							<tr>
								...
								<td>${telefone.tipo}</td>
								<td style="width: 5%">
									<button class="btn btn-danger" onclick="javascript:submeterManipulacaoTelefone('REMOVER', '${telefone.id}');" data-toggle="tooltip"
										title="Remover"
									>
								...
								<td style="width: 5%">
									<button class="btn btn-default" onclick="javascript:submeterManipulacaoTelefone('EDITAR', '${telefone.id}');" data-toggle="tooltip"
										title="Editar"
									>
